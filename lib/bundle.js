...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["e" /* fetchWHO */]().then(data => {
    const items = __WEBPACK_IMPORTED_MODULE_1__util__["f" /* formatWHO */](data);
...
class Globe {
  ...
  handleClick() {
    ...
    if (country) {
      __WEBPACK_IMPORTED_MODULE_1__util__["d" /* fetchCountry */](country.id).then(data => {
        debugger
        const donut = new __WEBPACK_IMPORTED_MODULE_2__donut__["a" /* default */](events);
        donut.setupDonut();
      });
    }
  }
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawObj */](ctx, this.path, this.water, this.colors.water);
    __WEBPACK_IMPORTED_MODULE_1__util__["b" /* drawLine */](ctx, this.path, this.grat, this.colors.grat);
    this.drawMap();
    // Util.drawObj(ctx, this.path, this.worldMap, this.colors.land);

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawObj */](ctx, this.path, this.highlight, 'white');
    }
...
/* harmony export (immutable) */ __webpack_exports__["e"] = fetchWHO;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = fetchCountry;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = formatWHO;
