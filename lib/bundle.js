...
/* harmony export (immutable) */ __webpack_exports__["f"] = who;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = fetchWHO;


const fetchCountry = (listItem, id) => {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = fetchCountry;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = formatWHO;


const formatWHOCountry = data => {
  let labels = {};
  let facts = {};
...
/* harmony export (immutable) */ __webpack_exports__["e"] = formatWHOCountry;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["f" /* who */]().then(data => {
    debugger
  })
...
class Globe {
  ...
  getItems() {
    this.startLoading();
    __WEBPACK_IMPORTED_MODULE_2__util__["c" /* fetchWHO */](this.currentListItem).then(data => {
      this.items = __WEBPACK_IMPORTED_MODULE_2__util__["d" /* formatWHO */](data);
  ...
  handleClick() {
    ...
    if (country) {
      __WEBPACK_IMPORTED_MODULE_2__util__["b" /* fetchCountry */](this.currentListItem, country.id).then(data => {
        if(country.id === 'NGA') {
          debugger
        }
        const facts = __WEBPACK_IMPORTED_MODULE_2__util__["e" /* formatWHOCountry */](data);
  ...
  render() {
    ...
    if (this.renderDims === this.dims) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["e" /* drawTitle */](ctx, this.worldMap.features[0].fact.title, this.renderDims);
    }
