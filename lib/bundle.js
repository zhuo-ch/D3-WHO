...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["e" /* nasa */]().then(data => {
...
class Globe {
  ...
  findHoverItem(event) {
    ...
    const ev = this.events.find(evt => __WEBPACK_IMPORTED_MODULE_1__util__["d" /* findEvent */](evt.geometries[0].coordinates, pos));
...
/* harmony export (immutable) */ __webpack_exports__["e"] = nasa;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = findEvent;
