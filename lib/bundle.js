...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__globe__ = __webpack_require__(1);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["g" /* fetchWHO */]().then(data => {
    const items = __WEBPACK_IMPORTED_MODULE_1__util__["h" /* formatWHO */](data);
    const globe = new __WEBPACK_IMPORTED_MODULE_0__globe__["a" /* default */](dims, items);
    globe.setup();
    globe.startGlobe();
  });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__world_map__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__donut__ = __webpack_require__(4);
...
class Globe {
  constructor(dims, items) {
    this.dims = dims
    this.items = items
    this.worldMap = __WEBPACK_IMPORTED_MODULE_1__util__["a" /* bindMap */](__WEBPACK_IMPORTED_MODULE_0__world_map__["a" /* worldMap */], items);
  ...
  handleClick() {
    ...
    if (country) {
      __WEBPACK_IMPORTED_MODULE_1__util__["f" /* fetchCountry */](country.id).then(data => {
        const facts = __WEBPACK_IMPORTED_MODULE_1__util__["i" /* formatWHOCountry */](data);
        const donut = new __WEBPACK_IMPORTED_MODULE_2__donut__["a" /* default */](facts, country);
        donut.drawDonut();
      });
    }
  }
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__util__["d" /* drawObj */](ctx, path, this.water, this.colors.water);
    __WEBPACK_IMPORTED_MODULE_1__util__["b" /* drawLine */](ctx, path, this.grat, this.colors.grat);
    __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawMap */](ctx, path, this.worldMap, this.colorGrad);

    if (this.renderDims === this.dims) {
      __WEBPACK_IMPORTED_MODULE_1__util__["e" /* drawTitle */](ctx, this.worldMap.features[0].fact.title, this.renderDims);
    }

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__util__["d" /* drawObj */](ctx, this.path, this.highlight, 'white');
    }
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["g"] = fetchWHO;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = fetchCountry;
...
/* harmony export (immutable) */ __webpack_exports__["h"] = formatWHO;
...
/* harmony export (immutable) */ __webpack_exports__["i"] = formatWHOCountry;
...
const drawEvents = (context, path, events, color, globe) => {
  let circles = [];
...
/* unused harmony export drawEvents */


const findEvent = (e, pos) => {
  const x = e[0], y = e[1];
...
/* unused harmony export findEvent */


const findCountryEvents = (country, events) => {
...
/* unused harmony export findCountryEvents */
