...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["f" /* nasa */]().then(data => {
    const events = __WEBPACK_IMPORTED_MODULE_1__util__["a" /* createGeoJSON */](data.events);
    const globe = new __WEBPACK_IMPORTED_MODULE_0__globe__["a" /* default */](canvas, context, events);
    globe.setupGlobe();
    globe.startRender();
  });
...
class Globe {
  ...
  findCountry(event) {
    ...
    const ev = this.events.features.find(evt => __WEBPACK_IMPORTED_MODULE_1__util__["e" /* findEvent */](evt.geometry.coordinates, pos));
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__util__["d" /* drawObj */](ctx, this.path, this.water, this.colors.water);
    __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawLine */](ctx, this.path, this.worldMap, this.colors.land);
    __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawLine */](ctx, this.path, this.grat, this.colors.grat);
    __WEBPACK_IMPORTED_MODULE_1__util__["b" /* drawEvents */](ctx, this.path, this.events.features, 'red');

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__util__["d" /* drawObj */](ctx, this.path, this.highlight, 'red');
    }
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["b"] = drawEvents;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = createGeoJSON;
