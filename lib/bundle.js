...
/* harmony export (immutable) */ __webpack_exports__["d"] = getCountry;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = formatWHO;
...
/* unused harmony export formatWHOCountry */
...
/* harmony export (immutable) */ __webpack_exports__["e"] = whoList;
...
class Globe {
  constructor(dims) {
    this.dims = dims
    this.whoList = __WEBPACK_IMPORTED_MODULE_2__util__["e" /* whoList */];
  ...
  getItems() {
    ...
    __WEBPACK_IMPORTED_MODULE_2__util__["b" /* fetchWHO */](this.currentListItem).then(data => {
      this.items = __WEBPACK_IMPORTED_MODULE_2__util__["c" /* formatWHO */](data);
  ...
  handleClick() {
    ...
    if (country) {
      ...
      $.when(...__WEBPACK_IMPORTED_MODULE_2__util__["d" /* getCountry */](this.currentListItem, country.id)).done((...args) => {
        debugger
      })
...
/* unused harmony default export */ var _unused_webpack_default_export = (Donut);
