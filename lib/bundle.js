...
class Globe {
  ...
  getItems() {
    this.startLoading();
    __WEBPACK_IMPORTED_MODULE_2__util__["b" /* fetchWHO */](this.currentListItem).then(data => {
  ...
  handleClick() {
    ...
    if (country) {
      ...
      $.when(...__WEBPACK_IMPORTED_MODULE_2__util__["f" /* getCountry */](this.currentListItem, country.id)).done((...args) => {
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["d" /* drawObj */](ctx, path, this.water, this.colors.water);
    ...
    if (this.renderDims === this.dims) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["e" /* drawTitle */](ctx, this.worldMap.features.find(el => el.fact).fact.title, this.renderDims);
    }

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["d" /* drawObj */](ctx, this.path, this.highlight, 'white');
    }
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["d"] = drawObj;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = drawTitle;
