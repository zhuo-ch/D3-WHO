...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["f" /* nasa */]().then(data => {
    const globe = new __WEBPACK_IMPORTED_MODULE_0__globe__["a" /* default */](dims, data.events);
    globe.setup();
    globe.startGlobe();
  });
  // drawSvg(dims);
...
class Globe {
  constructor(dims, events) {
    this.dims = dims
    this.events = events
    this.worldMap = __WEBPACK_IMPORTED_MODULE_0__world_map__["a" /* worldMap */];
  ...
  handleClick() {
    ...
    if (item) {
      const events = __WEBPACK_IMPORTED_MODULE_1__util__["d" /* findCountryEvents */](item, this.events);
  ...
  findHoverItem(event) {
    ...
    const ev = this.events.find(evt => __WEBPACK_IMPORTED_MODULE_1__util__["e" /* findEvent */](evt.geometries[0].coordinates, pos));
  ...
  render() {
    ...
    __WEBPACK_IMPORTED_MODULE_1__util__["b" /* drawLine */](ctx, this.path, this.worldMap, this.colors.land);
    __WEBPACK_IMPORTED_MODULE_1__util__["b" /* drawLine */](ctx, this.path, this.grat, this.colors.grat);

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawObj */](ctx, this.path, this.highlight, 'navy');
    }

    __WEBPACK_IMPORTED_MODULE_1__util__["a" /* drawEvents */](ctx, this.path, this.events, 'red');
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["f"] = nasa;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = drawEvents;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = findEvent;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = findCountryEvents;
