...
/* unused harmony export who */


const fetchWHO = (listItem) => {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = fetchWHO;


const getCountry = (listItem, id) => {
  return listItem.pieSource.map((source, idx)=> {
    return createAjax(listItem, id, idx);
  });
}
/* harmony export (immutable) */ __webpack_exports__["f"] = getCountry;


const createAjax = (listItem, id, idx) => {
...
/* unused harmony export createAjax */
...
/* harmony export (immutable) */ __webpack_exports__["a"] = bindMap;


const formatWHO = data => {
  const arr = [];
...
/* harmony export (immutable) */ __webpack_exports__["e"] = formatWHO;


const formatSingleIndicator = data => {
...
/* harmony export (immutable) */ __webpack_exports__["d"] = formatSingleIndicator;


const formatMultipleIndicators = data => {
  let facts = [];
...
/* harmony export (immutable) */ __webpack_exports__["c"] = formatMultipleIndicators;
...
/* unused harmony export createGeoJSON */
...
/* harmony export (immutable) */ __webpack_exports__["g"] = whoList;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__globe__ = __webpack_require__(2);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //   debugger
  // })
  const globe = new __WEBPACK_IMPORTED_MODULE_0__globe__["a" /* default */](dims);
  globe.setup();
});
...
/* harmony export (immutable) */ __webpack_exports__["whoList"] = whoList;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__world_map__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__draw_util__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__donut__ = __webpack_require__(5);
...
class Globe {
  constructor(dims) {
    this.dims = dims
    this.whoList = __WEBPACK_IMPORTED_MODULE_2__util__["g" /* whoList */];
  ...
  getItems() {
    ...
    this.startLoading();
    __WEBPACK_IMPORTED_MODULE_2__util__["b" /* fetchWHO */](this.whoList[this.currentListItem]).then(data => {
      this.items = __WEBPACK_IMPORTED_MODULE_2__util__["e" /* formatWHO */](data);
      this.worldMap = __WEBPACK_IMPORTED_MODULE_2__util__["a" /* bindMap */](__WEBPACK_IMPORTED_MODULE_0__world_map__["a" /* worldMap */], this.items);
  ...
  handleClick() {
    if (this.findMenuItem(d3.event)) {
      ...
      $.when(...__WEBPACK_IMPORTED_MODULE_2__util__["f" /* getCountry */](this.whoList[this.currentListItem], country.id)).done((...args) => {
        const facts = args.every(el => Array.isArray(el)) ? __WEBPACK_IMPORTED_MODULE_2__util__["c" /* formatMultipleIndicators */](args) : __WEBPACK_IMPORTED_MODULE_2__util__["d" /* formatSingleIndicator */](args[0]);
        this.setupMini();
        this.donut = new __WEBPACK_IMPORTED_MODULE_3__donut__["a" /* default */]([this.dims[0], this.dims[1] - this.renderDims[1]], facts, country);
  ...
  renderLoading(time) {
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["c" /* drawLoading */](this.context, this.renderDims, time);
  }
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["f" /* drawObj */](ctx, path, this.water, this.colors.water);
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["b" /* drawLine */](ctx, path, this.grat, this.colors.grat);
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["d" /* drawMap */](ctx, path, this.worldMap, this.colorGrad);

    if (this.renderDims === this.dims) {
      this.menuItems = __WEBPACK_IMPORTED_MODULE_1__draw_util__["e" /* drawMenu */](ctx, this.dims, this.currentListItem);
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["g" /* drawTitle */](ctx, this.title, this.renderDims);
    }

    if (this.menuHighlight) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["a" /* drawHighlight */](ctx, this.menuHighlight);
    }

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["f" /* drawObj */](ctx, this.path, this.highlight, 'white');
    }
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = worldMap;
...
"use strict";
const drawObj = (ctx, path, obj, color) => {
    ctx.beginPath();
    path(obj);
    ctx.fillStyle = color;
    ctx.fill();
  }
/* harmony export (immutable) */ __webpack_exports__["f"] = drawObj;


const drawLine = (ctx, path, line, color) => {
    ctx.beginPath();
    path(line);
...
const drawMap = (ctx, path, worldMap, colorGrad) => {
...
/* harmony export (immutable) */ __webpack_exports__["d"] = drawMap;
...
/* harmony export (immutable) */ __webpack_exports__["g"] = drawTitle;


const drawMenu = (ctx, dims, currentIndicator) => {
  let x = dims[0] * 3 / 4;
  let y = (dims[1] / 3) - 100;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = drawMenu;


const drawHighlight = (ctx, coords) => {
  ctx.strokeStyle = 'yellow';
  ctx.lineWidth = 3;
  ctx.strokeRect(coords.nw[0] - 3, coords.nw[1] - 3, 16, 16);
}
/* harmony export (immutable) */ __webpack_exports__["a"] = drawHighlight;


const drawLoading = (ctx, dims, time) => {
...
/* harmony export (immutable) */ __webpack_exports__["c"] = drawLoading;
...
/* harmony default export */ __webpack_exports__["a"] = (Donut);
