...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["f" /* fetchWHO */]().then(data => {
    const items = __WEBPACK_IMPORTED_MODULE_1__util__["g" /* formatWHO */](data);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__donut___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__donut__);
...
class Globe {
  ...
  handleClick() {
    ...
    if (country) {
      __WEBPACK_IMPORTED_MODULE_1__util__["e" /* fetchCountry */](country.id).then(data => {
        const facts = __WEBPACK_IMPORTED_MODULE_1__util__["h" /* formatWHOCountry */](data);
        const donut = new __WEBPACK_IMPORTED_MODULE_2__donut__["default"](facts);
        donut.setupDonut();
      });
    }
  }
...
/* harmony export (immutable) */ __webpack_exports__["f"] = fetchWHO;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = fetchCountry;
...
/* harmony export (immutable) */ __webpack_exports__["g"] = formatWHO;
...
/* harmony export (immutable) */ __webpack_exports__["h"] = formatWHOCountry;
...
"use strict";
throw new Error("Module parse failed: /Users/Sevilla/Desktop/Jobilee/lib/donut.js Unexpected token (37:4)\nYou may need an appropriate loader to handle this file type.\n|       .attr('fill', 'white')\n|       .on('mouseover', () => this.attr('fill', 'white'));\n|     .transition()\n|       .delay(() => {\n|         delay += 50;");
