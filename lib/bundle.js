...
class Globe {
  ...
  renderLoading(time) {
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["b" /* drawLoading */](this.context, this.renderDims, time);
  }
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["e" /* drawObj */](ctx, path, this.water, this.colors.water);
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["a" /* drawLine */](ctx, path, this.grat, this.colors.grat);
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["c" /* drawMap */](ctx, path, this.worldMap, this.colorGrad);

    if (this.renderDims === this.dims) {
      this.menuItems = __WEBPACK_IMPORTED_MODULE_1__draw_util__["d" /* drawMenu */](ctx, this.dims, this.currentListItem);
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["f" /* drawTitle */](ctx, this.worldMap.features.find(el => el.fact).fact.title, this.renderDims);
    }

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["e" /* drawObj */](ctx, this.path, this.highlight, 'white');
    }
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["e"] = drawObj;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = drawTitle;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = drawMenu;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = drawLoading;
