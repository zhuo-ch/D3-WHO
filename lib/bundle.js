...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["c" /* fetchWHO */]().then(data => {
    const items = __WEBPACK_IMPORTED_MODULE_1__util__["d" /* formatWHO */](data);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__draw_util__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__donut__ = __webpack_require__(4);
...
class Globe {
  constructor(dims, items) {
    this.dims = dims
    this.items = items
    this.worldMap = __WEBPACK_IMPORTED_MODULE_2__util__["a" /* bindMap */](__WEBPACK_IMPORTED_MODULE_0__world_map__["a" /* worldMap */], items);
  ...
  handleClick() {
    ...
    if (country) {
      __WEBPACK_IMPORTED_MODULE_2__util__["b" /* fetchCountry */](country.id).then(data => {
        const facts = __WEBPACK_IMPORTED_MODULE_2__util__["e" /* formatWHOCountry */](data);
        const donut = new __WEBPACK_IMPORTED_MODULE_3__donut__["a" /* default */](facts, country);
        donut.drawDonut();
      });
    }
  }
  ...
  render() {
    ...
    ctx.globalAlpha = 0.7;
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["c" /* drawObj */](ctx, path, this.water, this.colors.water);
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["a" /* drawLine */](ctx, path, this.grat, this.colors.grat);
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["b" /* drawMap */](ctx, path, this.worldMap, this.colorGrad);

    if (this.renderDims === this.dims) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["d" /* drawTitle */](ctx, this.worldMap.features[0].fact.title, this.renderDims);
    }

    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__draw_util__["c" /* drawObj */](ctx, this.path, this.highlight, 'white');
    }
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["c"] = drawObj;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = drawTitle;
