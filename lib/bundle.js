...
document.addEventListener('DOMContentLoaded', () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1__util__["e" /* nasa */]().then(data => {
    const globe = new __WEBPACK_IMPORTED_MODULE_0__globe__["a" /* default */](canvas, context, data.events);
    globe.setupGlobe();
    globe.startRender();
  });
...
class Globe {
  ...
  render() {
    ...
    if (this.highlight) {
      __WEBPACK_IMPORTED_MODULE_1__util__["c" /* drawObj */](ctx, this.path, this.highlight, 'red');
    }
  }
}
