...
// http://apps.who.int/gho/athena/data/GHO/MORT_100.json?filter=CHILDCAUSE:*;COUNTRY:AND
export const fetchCountry = (id) => {
  return $.ajax({
    method: 'GET',
    dataType: 'jsonp',
    url: `http://apps.who.int/gho/athena/api/GHO/MORT_100?filter=COUNTRY:${id};CHILDCAUSE:*&format=json`,
  });
}
